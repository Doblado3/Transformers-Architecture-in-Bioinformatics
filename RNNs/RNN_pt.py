...
#Ahora veremos cómo se construye una RNN simple con la librería Pytorch
...
optimizer = optimizers.Adam(model.parameters(), lr=lr, betas=(beta1, beta2), amsgrad=True)
