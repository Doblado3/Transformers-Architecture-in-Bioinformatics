#
# Sine wave prediction using Simple-RNN of Tensorflow.
#
...
#Tras construir la RNN simple desde 0, vamos a hacer usando la librería tensorflow.

#####Hay un error con la importación de tensorflow.keras, pero parece que funciona igualmente
##### y si lo arreglo no funciona
